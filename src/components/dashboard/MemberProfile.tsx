...
const MemberProfile: React.FC = () => {
  ...
  // Photo upload removed for free version
  ...
  // Photo upload removed for free version - using avatar initials instead
    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600">Manage your personal information and photo</p>
        </div>
        {!isEditing && (
          <motion.button
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        >
          <div className="text-center">
            <div className="mb-4">
              <div className="w-24 h-24 bg-gradient-to-br from-primary-400 to-secondary-600 rounded-full mx-auto flex items-center justify-center border-4 border-primary-100">
            ...
            <div>
              ...
              <div className="mt-4">
                ...
                <textarea
                  {...register('bio')}
                  rows={4}
                  placeholder="Tell us about yourself, your interests, and what you bring to the team..."
                  disabled={!isEditing}
                  className={`input-field ${!isEditing ? 'bg-gray-50' : ''}`}
                />
